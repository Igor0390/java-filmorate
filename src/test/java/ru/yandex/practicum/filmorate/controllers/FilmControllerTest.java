...
class FilmControllerTest {
    ...
    public void beforeEach() {
        film = new Film(1l, "Film1", "Description1", LocalDate.of(1994, 11, 02), 190);
        film2 = new Film(2l, "Film2", "Description2", LocalDate.of(2010, 9, 03), 190);
    ...
    public void updateFilm() {
        ...
        film2 = new Film(2l, "Film3", "Description3", LocalDate.of(1555, 7, 15), 190);
